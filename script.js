document.addEventListener('DOMContentLoaded', () => {
    ...
    if (btnAccept && btnDecline) {
        btnAccept.addEventListener('click', (e) => {
            ...
            responseMsg.innerHTML = "உங்கள் வருகையை ஆவலுடன் எதிர்பார்க்கிறோம்.";
        ...
        btnDecline.addEventListener('click', () => {
            rsvpContainer.style.display = 'none';
            responseMsg.innerHTML = "உங்கள் வருகையை இழக்கிறோம், ஆயினும் உங்கள் செபங்களுக்கும் ஆசீர்வாதங்களுக்கும் நன்றி.";
